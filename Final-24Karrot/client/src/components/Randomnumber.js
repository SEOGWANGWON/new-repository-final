    ...
    <div>
      ...
      <a href='/GameLand'><h5 id='gamelandtitle'>게임랜드</h5></a>
        ...
        <div id='lottoSubmit'>
          ...
          <span id='lottonumbertitledescription'>1부터 10까지의 숫자 네 자리를 맞추면 자그마한 선물을 받을 수 있어요!</span>
          <div id='lottoform'>
            ...
            <h5 id='inputlottonumber'>네 번째 숫자</h5>
              ...
              placeholder='?'
              onChange={(e)=>updateUserChooseNumber({number1: e.target.value})}/>
              <input 
              className='form-control'
              id='lottonum1'
              type='number'
              ...
              placeholder='?'
              onChange={(e)=>updateUserChooseNumber({number2: e.target.value})}/>
              <input 
              className='form-control'
              id='lottonum1'
              type='number'
              ...
              onChange={(e)=>updateUserChooseNumber({number3: e.target.value})}/>
              <input 
              className='form-control'
              id='lottonum1'
              type='number'
              ...
              required={true}
              onChange={(e)=>updateUserChooseNumber({number4: e.target.value})}/>
            </div>
            <button className='btn' id='lottobtn' onClick={handlesubmit}>로또 사기</button>
            </div>
        </div>
      </div>
      </div>
